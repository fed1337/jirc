...
class KeyboardHook {
    static {
        final String var0 = "HpqKbHook-" + Integer.toHexString(virtdevs.UID) + ".dll";
    ...
    private final byte[] kcmd = new byte[10];
    ...
    public void setKeyboardLayoutId(final int var1) {
        this.keyboardLayoutId = var1;
    }

    private void HandleSpecialKey(final int var1, final int var2) {
    ...
    public byte[] HandleHookKey(int var1, final int var2, final boolean var3, final boolean var4) {
        ...
        if (var4) {
            ...
            if (var5 != this.keyMap[var1]) {
                ...
                for (int var7 = 0; 256 > var6; ++var6) {
                    if (0 != this.keyMap[var6]) {
                        int var8;
                        ...
                        if (0 != var8 && 255 != var8) {
                            if (224 == (var8 & 224)) {
                                var8 ^= 224;
                                final byte[] var10000 = this.kcmd;
                                var10000[2] = (byte) ((int) var10000[2] | (int) (byte) (1 << var8));
                            } else {
